...
Execute unit tests
```
    cd "ATS.Enerprise.AWS.Lambda.Service/test/ATS.Enerprise.AWS.Lambda.Service.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "ATS.Enerprise.AWS.Lambda.Service/src/ATS.Enerprise.AWS.Lambda.Service"
